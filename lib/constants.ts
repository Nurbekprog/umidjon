...
export const SKILLS: Skill[] = [
  {
    ...
    icon: "Pen",
    level: 95,
    description: "UI/UX design, interactive prototypes, and design systems in Figma",
    category: "Design",
  },
  {
    ...
    icon: "PenTool",
    level: 93,
    description: "Vector graphics, logo design, and brand identity illustration",
    category: "Design",
  },
  {
    ...
    icon: "Image",
    level: 90,
    description: "Photo manipulation, digital art, and high-end visual retouching",
    category: "Design",
  },
  {
    ...
    icon: "Play",
    level: 85,
    description: "Motion graphics, kinetic typography, and animated visual content",
    category: "Motion",
  },
  {
    ...
    icon: "Film",
    level: 80,
    description: "Video editing and post-production for brand and social media content",
    category: "Motion",
  },
  {
    name: "Adobe InDesign",
    icon: "Layout",
    level: 82,
    description: "Print and digital layout design — magazines, brochures, and books",
    category: "Print",
  },
  {
    name: "Blender",
    icon: "RotateCcw",
    level: 70,
    description: "3D modeling and rendering for product visualization and abstract art",
    category: "3D",
  },
  {
    name: "Brand Identity",
    icon: "Star",
    level: 92,
    description: "Creating cohesive brand systems — logo, palette, typography, guidelines",
    category: "Strategy",
  },
  {
    name: "UI/UX Design",
    icon: "Monitor",
    level: 90,
    description: "User research, wireframing, and high-fidelity interface design",
    category: "Design",
  },
  {
    name: "Typography",
    icon: "Type",
    level: 88,
    description: "Typeface pairing, hierarchy, and expressive typographic layouts",
    category: "Design",
  },
  {
    name: "Color Theory",
    icon: "Palette",
    level: 91,
    description: "Strategic use of color psychology and harmony in visual design",
    category: "Design",
  },
  {
    ...
    icon: "Globe",
    level: 87,
    description: "Eye-catching content for Instagram, YouTube, and digital campaigns",
    category: "Digital",
  },
];
...
export const INSTAGRAM_POSTS: InstagramPost[] = [
  ...
  {
    id: "ig-2",
    caption: "Mobile app UI concept — clean layout, soft shadows, and a calm color system.",
  ...
  {
    id: "ig-4",
    caption: "Poster series for a music festival — bold type, vivid gradients, and raw energy.",
  ...
  {
    id: "ig-5",
    caption: "Dark mode design system — deep tones, glass layers, and sharp contrast hierarchy.",
